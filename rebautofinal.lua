...
while continueLoop do
    ...
    -- First block of code
    local strengthValue = game:GetService("ReplicatedStorage").Datas[playerName.UserId].Strength.Value
    if strengthValue < 100000 then
        local args1 = {
            [1] = "Blacknwhite27",
            [2] = 1
        }
    ...
    local defenceValue = game:GetService("ReplicatedStorage").Datas[playerName.UserId].Defense.Value
    if defenceValue < 100000 then
        local args2 = {
            [1] = "Blacknwhite27"
        }
    ...
    local energyValue = game:GetService("ReplicatedStorage").Datas[playerName.UserId].Energy.Value
    if energyValue < 100000 then
        local args3 = {
            [1] = 1,
            [2] = true,
    ...
    local speedValue = game:GetService("ReplicatedStorage").Datas[playerName.UserId].Speed.Value
    if speedValue < 100000 then
        local args4 = {
            [1] = "Blacknwhite27"
        }
